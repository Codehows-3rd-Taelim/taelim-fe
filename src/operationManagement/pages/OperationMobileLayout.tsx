    ...
    <div className="p-4">
      ...
      <div className="flex justify-end mb-4">
        <button
          ...
          className="px-3 py-2 text-black bg-orange-500 rounded-md hover:bg-orange-600"
        >
          로그아웃
        </button>
      </div>
      ...
      {roleLevel !== 1 ? (
        <div className="p-4 mb-6 bg-white shadow-md rounded-xl">
          <h3 className="mb-3 text-lg font-bold">직원 등록</h3>
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className={`h-10 px-3 rounded-md text-black ${
                isIdChecked ? "bg-green-600" : "bg-orange-500"
              }`}
            >
            ...
            <button
              ...
              className={`h-10 w-full rounded-md text-black ${
                isRegisterButtonEnabled
        ...
        <div className="p-4 mb-6 font-bold text-center text-orange-500 bg-white shadow-md rounded-xl">
          직원 등록 권한이 없습니다.
        </div>
      )}
      ...
      {roleLevel === 3 && (
        <>
          ...
          <div className="p-4 bg-white shadow-md rounded-b-xl">
            {activeTab === "employee" ? (
              <EmployeePage
                list={list}
                setList={setList}
